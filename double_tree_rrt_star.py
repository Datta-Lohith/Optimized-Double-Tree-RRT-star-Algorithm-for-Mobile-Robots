...
# Creating the map
X_Dimensions,Obstacles,map_image=create_map(map_no)
...
Q = np.array([(8, 8)])                          # Length of edges(Control Input)
...
end_time=time.time()
print(f"\nTime taken to execute the code is: {(end_time-start_time)/60} minutes.")